...
+function(a) {
    ...
    b.prototype.toggle = function() {
        ...
        if (b.length) {
            ...
            if (c.prop("type") == "radio") {
                if (c.prop("checked") && this.$element.hasClass("active")) a = false; else b.find(".active").removeClass("active");
            }
            if (a) c.prop("checked", !this.$element.hasClass("active")).trigger("change");
        } else {
            this.$element.attr("aria-pressed", !this.$element.hasClass("active"));
        }
        if (a) this.$element.toggleClass("active");
    };
    function c(c) {
        return this.each(function() {
            var d = a(this);
    ...
    a(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(b) {
        ...
        a(b.target).closest(".btn").toggleClass("focus", b.type == "focus");
    });
}(jQuery);
...
+function(a) {
    ...
    b.prototype.slide = function(c, d) {
        ...
        var k = f[0];
        var l = a.Event("slide.bs.carousel", {
            relatedTarget: k,
            direction: h
        });
...
+function(a) {
    ...
    d.prototype.keydown = function(b) {
        if (!/(38|40|27|32)/.test(b.which)) return;
        var d = a(this);
        b.preventDefault();
        b.stopPropagation();
    ...
    function e(d) {
        ...
        a(c).each(function() {
            ...
            c.trigger(d = a.Event("hide.bs.dropdown", e));
            if (d.isDefaultPrevented()) return;
            b.attr("aria-expanded", "false");
            c.removeClass("open").trigger("hidden.bs.dropdown", e);
        });
    }
    function f(b) {
    ...
    a(document).on("click.bs.dropdown.data-api", e).on("click.bs.dropdown.data-api", ".dropdown form", function(a) {
        a.stopPropagation();
    }).on("click.bs.dropdown.data-api", c, d.prototype.toggle).on("keydown.bs.dropdown.data-api", c, d.prototype.keydown).on("keydown.bs.dropdown.data-api", '[role="menu"]', d.prototype.keydown).on("keydown.bs.dropdown.data-api", '[role="listbox"]', d.prototype.keydown);
}(jQuery);
...
+function(a) {
    ...
    b.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (j) {
                ...
                h = h == "bottom" && k.bottom + m > p.bottom ? "top" : h == "top" && k.top - m < p.top ? "bottom" : h == "right" && k.right + l > p.width ? "left" : h == "left" && k.left - l < p.left ? "right" : h;
            ...
            a.support.transition && this.$tip.hasClass("fade") ? f.one("bsTransitionEnd", r).emulateTransitionEnd(b.TRANSITION_DURATION) : r();
        }
    };
    ...
    b.prototype.hide = function(c) {
        ...
        if (f.isDefaultPrevented()) return;
        e.removeClass("in");
        a.support.transition && this.$tip.hasClass("fade") ? e.one("bsTransitionEnd", g).emulateTransitionEnd(b.TRANSITION_DURATION) : g();
    ...
    function c(c) {
        return this.each(function() {
            ...
            if (g) {
                if (!e) d.data("bs.tooltip", e = {});
                if (!e[g]) e[g] = new b(this, f);
            } else {
...
+function(a) {
    ...
    function b(c, d) {
        ...
        this.$body = a("body");
        this.$scrollElement = a(c).is("body") ? a(window) : a(c);
        this.options = a.extend({}, b.DEFAULTS, d);
